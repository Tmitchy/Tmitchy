...
|---|---|---|
| 🖥️ [**SOC Home Lab Build**](https://github.com/Tmitchy/SOC-Home-Lab-Build](https://github.com/Tmitchy/-SOC-Home-Lab-Build)) | I'm setting up my lab with Windows 11, Windows Server, Ubuntu Server, and Ubuntu Desktop, configuring each to forward logs in preparation for introducing a SIEM. | 🟡 In Progress — Stage 1 complete, SIEM integration next |
